        ...
        <article id="contenedor">
            <section class="data">
                <div class="contenedor-Int">
                    ...
                    <br>
                    <img style="width: 80px; height: 80px; border-radius: 50%; " src="../Rostros/<?php echo $row['imagen']; ?>" alt="">
                    <span><?php echo $row['name']  ?></span>
                     <p><?php echo $row['Correo']; ?></p>
                     <p><?php echo $row['access']; ?></p>

        </div>
    
                    <br>
                    <label for="CID"><h2 class="t">Si se le ha dado de baja, borre el perfil</h2></label>
                    <input type="checkbox" id="CID" onclick="check()">
                    <br>
                        <input type="submit" value="Borrar" disabled id="borrar">
                    </form>
                </div>
            </section>
